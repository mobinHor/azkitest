...
import { TransUserName } from '../../handlers/Translators'
    ...
    return (
        <nav id="Navbar">
            <ul className='d-flex align-items-center justify-content-between p-5'>
                ...
                <li className='font-weight-bold'><img alt="" style={{width:'25px'}} src={userIcon}/> {userInfo ? TransUserName(userInfo) : 'ثبت نام'}</li>
            </ul>
        </nav>
    )
}
